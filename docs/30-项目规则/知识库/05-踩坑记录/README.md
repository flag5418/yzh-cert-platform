...
> ⚠️ **定位更新（2026-09-29）**：本目录 14 篇踩坑记录均基于 **Vol 旧框架**（2026-08 实施过程），新架构（YZH.Core V4 2026-09 起）已弃用 Vol，**本页仅作历史追溯参考**。新架构常见问题请查阅 [`10-YZH架构/08-常见错误与修复.md`](../10-YZH架构/08-常见错误与修复.md)。
