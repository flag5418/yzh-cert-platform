...
**SQL脚本位置**: `/docs/90-归档/旧版本/sql/cert_phase2_data_dictionary.sql`
...
**SQL脚本位置**: `/docs/90-归档/旧版本/sql/cert_phase2_test_data.sql`
...
# 执行数据字典脚本
source /path/to/docs/90-归档/旧版本/sql/cert_phase2_data_dictionary.sql

# 执行测试数据脚本
source /path/to/docs/90-归档/旧版本/sql/cert_phase2_test_data.sql
```
