...
> 对应踩坑见：[2026-08-03 踩坑记录 P2-06](../../30-项目规则/知识库/05-踩坑记录/2026-08-03_Phase2联调全栈问题修复记录.md)
...
| 现象 | 入口文档 |
|------|----------|
| 接口 500 / Unknown column / repository null | [Phase2 联调踩坑记录 P2-01~P2-03](../../30-项目规则/知识库/05-踩坑记录/2026-08-03_Phase2联调全栈问题修复记录.md) |
