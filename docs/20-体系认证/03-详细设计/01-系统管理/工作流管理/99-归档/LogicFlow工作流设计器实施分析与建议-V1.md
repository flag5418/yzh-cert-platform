...
| # | 文档 | 动作 | 归属目录 |
|---|------|------|---------|
| 1 | `数据库表设计-V2.md` §F-03 | 将 workflow_config JSON 示例更新为**新结构**（多端口 outputs + sourceHandle/targetHandle + branches） | `docs/90-归档/旧版本/` |
| 2 | `YZH-AI引擎详细设计-V1.md` §4.2 | 同步 workflow_config 结构至新格式（camelCase 键名统一） | `docs/20-体系认证/03-详细设计/01-系统管理/工作流管理/` → 完成后移入 `docs/20-体系认证/03-详细设计/03-平台基础/` |
| 3 | 更新本文件（本文档） | 根据实际实施情况更新各 Phase 状态 | `docs/20-体系认证/03-详细设计/01-系统管理/工作流管理/` |
| 4 | `docs/20-体系认证/03-详细设计/README.md` | 新增本文档条目 | `docs/20-体系认证/03-详细设计/` |
