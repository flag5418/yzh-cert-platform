...
> **版本**：V3 | **状态**：待审核
> **前置文档**：
> - 数据库设计：`docs/90-归档/旧版本/数据库表设计-V2.md` §3.2 A-10/A-03
> - 标准约束：`docs/30-项目规则/知识库/03-边界与约束/ISO体系认证NC与报告标准约束-V1.md`
> - 功能总览：`docs/20-体系认证/03-详细设计/01-系统管理/工作流管理/01-核心引擎/审核规则库与工作流设计器-功能设计-V4.md`
>
