...
| 技术研究-文档解析开源方案与轻量部署-V1.md | **技术选型研究**：anydoc / MinerU 文档解析方案对比、轻量服务器（2核/1G/50G/OSS）部署可行性 | 成熟态 |
| 技术研究-文档解析开源方案与轻量部署-V1.md（配套） | anydoc 容器已落地：`docker/anydoc/`（Dockerfile + 运行方式 README），容器 `yzh-anydoc`，详见 `docker/anydoc/README.md` | 成熟态 |
