...
| **数据库** | MySQL 8.0 | 主存储 |
| **对象存储** | MinIO | 文件/附件存储 |
| **AI 工作流** | Dify 或 n8n | 开源 AI 编排平台（替代自研） |
...
| M09 | **AI 工作流** | 基于 Dify/n8n 的 AI 能力编排 | OCR 文字识别；语音转文字；报告智能生成；标准条款推荐；Prompt 模板管理 | P1-P2 |
...
| ADR-006 | **采用 Dify/n8n 做 AI 编排** | 不自研 AI 工作流引擎，降低开发成本 | 2026-07-28 |
