...
ADD COLUMN Status VARCHAR(50) DEFAULT 'active' COMMENT '业务状态' AFTER CbCode;

-- 2. ISO 标准表
ALTER TABLE cert_iso_standard 
ADD COLUMN Status VARCHAR(50) DEFAULT 'active' COMMENT '业务状态' AFTER StandardCode;

-- 3. 认证申请表
ALTER TABLE cert_application 
ADD COLUMN Status VARCHAR(50) DEFAULT 'draft' COMMENT '业务状态' AFTER ApplicationNo;
