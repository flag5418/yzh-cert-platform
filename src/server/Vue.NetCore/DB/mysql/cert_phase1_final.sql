...
('cert_certification_body', 'Remark'),
...
-- 第八部分：示例机构和审核员
-- ============================================================
INSERT IGNORE INTO `cert_org_config` (`Code`, `OrgCode`, `org_name`, `org_short_name`, `org_type`, `registration_no`, `LegalPerson`, `ContactPhone`, `ContactEmail`, `Address`, `Status`, `max_users`, `max_enterprises`) VALUES
...
SELECT 'cb001_admin', 'fAiqPZF6bVj4G7+qJcVaLQ==', '审核管理员', 200, '审核管理员', UUID(), 1, 2, 1, 20, 'CB001', Id, 'admin@shanglong.cn', '13900000001', '李四（尚龙认证管理员）', 1, NOW() FROM `cert_org_config` WHERE `OrgCode` = 'CB001' LIMIT 1;

INSERT IGNORE INTO `Sys_User` (`UserName`, `UserPwd`, `UserTypeName`, `RoleId`, `RoleName`, `Token`, `AppType`, `AuditStatus`, `Enable`, `UserType`, `OrgCode`, `OrgId`, `Email`, `Mobile`, `UserTrueName`, `CreateID`, `CreateDate`)
SELECT 'cb001_leader', 'fAiqPZF6bVj4G7+qJcVaLQ==', '审核组长', 201, '审核组长', UUID(), 1, 2, 1, 21, 'CB001', Id, 'leader@shanglong.cn', '13900000002', '王五（尚龙审核组长）', 1, NOW() FROM `cert_org_config` WHERE `OrgCode` = 'CB001' LIMIT 1;

INSERT IGNORE INTO `Sys_User` (`UserName`, `UserPwd`, `UserTypeName`, `RoleId`, `RoleName`, `Token`, `AppType`, `AuditStatus`, `Enable`, `UserType`, `OrgCode`, `OrgId`, `Email`, `Mobile`, `UserTrueName`, `CreateID`, `CreateDate`)
SELECT 'cb001_auditor', 'fAiqPZF6bVj4G7+qJcVaLQ==', '普通审核员', 202, '普通审核员', UUID(), 1, 2, 1, 22, 'CB001', Id, 'auditor@shanglong.cn', '13900000003', '赵六（尚龙审核员）', 1, NOW() FROM `cert_org_config` WHERE `OrgCode` = 'CB001' LIMIT 1;
...
-- ============================================================
INSERT IGNORE INTO `Sys_User` (`UserName`, `UserPwd`, `UserTypeName`, `RoleId`, `RoleName`, `Token`, `AppType`, `AuditStatus`, `Enable`, `UserType`, `OrgCode`, `OrgId`, `Email`, `Mobile`, `UserTrueName`, `CreateID`, `CreateDate`)
SELECT 'ent001_user', 'fAiqPZF6bVj4G7+qJcVaLQ==', '企业账号', 300, '企业账号', UUID(), 1, 2, 1, 30, 'CB001', Id, 'ent@testcompany.com', '13700000001', '孙七（测试企业管理员）', 1, NOW() FROM `cert_org_config` WHERE `OrgCode` = 'CB001' LIMIT 1;
