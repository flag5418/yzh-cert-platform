...
namespace YZH.WebApi.Controllers.Admin.Platform
{
    ...
    public class EnterpriseController : ApiBaseController<IEnterpriseService>
    {
        ...
        public async Task<IActionResult> Create([FromBody] YZH.Entity.Admin.Platform.Ent.Enterprise entity)
        {
        ...
        public async Task<IActionResult> Update([FromBody] YZH.Entity.Admin.Platform.Ent.Enterprise entity)
        {
