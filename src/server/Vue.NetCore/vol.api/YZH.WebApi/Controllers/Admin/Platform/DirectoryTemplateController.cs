...
namespace YZH.WebApi.Controllers.Admin.Platform
{
    ...
    public class DirectoryTemplateController : ApiBaseController<IDirectoryTemplateService>
    {
        ...
        public async Task<IActionResult> AddFolder([FromBody] YZH.Entity.Admin.Platform.Cert.DirectoryTemplate entity)
        {
        ...
        public async Task<IActionResult> UpdateFolder([FromBody] YZH.Entity.Admin.Platform.Cert.DirectoryTemplate entity)
        {
        ...
        public async Task<IActionResult> SaveFileRequirement([FromBody] YZH.Entity.Admin.Platform.Cert.FileRequirement entity)
        {
