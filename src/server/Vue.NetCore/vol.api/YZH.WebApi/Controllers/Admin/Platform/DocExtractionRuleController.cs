...
// using YZH.Entity.Admin.Platform.Dir; // 废弃，待企业文件实体重建后恢复
...
namespace YZH.WebApi.Controllers.Admin.Platform
{
    ...
    public class DocExtractionRuleController : ApiBaseController<object>
    {
        ...
        // {
        //     var dirService = AutofacContainerModule.GetService<YZH.Builder.IServices.CertPlatform.IStandardDirectoryService>();
        //     if (dirService == null)
        ...
        //     var minio = AutofacContainerModule.GetService<YZH.Builder.IServices.CertPlatform.IMinIOHelper>();
