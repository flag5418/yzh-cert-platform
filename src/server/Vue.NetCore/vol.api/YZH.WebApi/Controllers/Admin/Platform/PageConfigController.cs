 ...
 * 前端调用方: ConfigLoader（Vue 组件）
 */
using Microsoft.AspNetCore.Mvc;
using System;
using System.Linq;
using System.Threading.Tasks;
using YZH.Core.Filters;  // JWTAuthorize 所在命名空间
...
namespace YZH.WebApi.Controllers.Admin.Platform
{
    ...
    /// <para>提供数据库驱动的 UI 配置查询接口，供前端 ConfigLoader 调用</para>
    ...
    public class PageConfigController : ControllerBase
    {
        ...
        public PageConfigController(IYzhPageConfigService service)
        {
            _service = service;
        }
