...
namespace VOL.WebApi.Controllers.Admin.Platform
{
    ...
    public class DirectoryTemplateController : ApiBaseController<IDirectoryTemplateService>
    {
        ...
        public async Task<IActionResult> AddFolder([FromBody] VOL.Entity.Admin.Platform.Cert.DirectoryTemplate entity)
        {
        ...
        public async Task<IActionResult> UpdateFolder([FromBody] VOL.Entity.Admin.Platform.Cert.DirectoryTemplate entity)
        {
        ...
        public async Task<IActionResult> SaveFileRequirement([FromBody] VOL.Entity.Admin.Platform.Cert.FileRequirement entity)
        {
