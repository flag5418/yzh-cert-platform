...
namespace VOL.WebApi.Controllers.Admin.Platform
{
    ...
    public class EnterpriseController : ApiBaseController<IEnterpriseService>
    {
        ...
        public async Task<IActionResult> Create([FromBody] VOL.Entity.Admin.Platform.Ent.Enterprise entity)
        {
        ...
        public async Task<IActionResult> Update([FromBody] VOL.Entity.Admin.Platform.Ent.Enterprise entity)
        {
