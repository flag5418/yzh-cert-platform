...
namespace YZH.Core.Services
{
    ...
    /// 3. 声明式删除策略 - 读取[DeleteStrategy]特性决定Logical/Physical/Cascade
        ...
        where TRepository : IRepository<TEntity>
    {
        ...
        /// 当前实现：先走标准逻辑删除，后续扩展
        /// </summary>
        private WebResponseContent ExecuteCascadeDelete(object[] keys, List<TEntity> entities, DeleteStrategyAttribute? attr)
        {
