...
///       : TreeServiceBase&lt;DirectoryTemplate, IDirectoryTemplateRepository&gt;
///       , IDirectoryTemplateService, IDependency
///   { }
/// </summary>
public abstract class TreeServiceBase<TEntity, TRepository>
    : TableServiceBase<TEntity, TRepository>
    where TEntity : BaseEntity
    where TRepository : IRepository<TEntity>
{
    public TreeServiceBase() { }
    public TreeServiceBase(TRepository repository) : base(repository) { }
