...
/// <summary>
/// 单表 CRUD 专用基类（90% 场景）。
/// 继承 ServiceBase，新增 QueryView 视图查询支持。
///
/// 使用：
///   // 零配置
///   public class CertStageService
///       : TableServiceBase&lt;CertStage, ICertStageRepository&gt;
...
/// </summary>
public abstract class TableServiceBase<TEntity, TRepository>
    : ServiceBase<TEntity, TRepository>
    where TEntity : BaseEntity
    where TRepository : IRepository<TEntity>
{
    public TableServiceBase() { }
    public TableServiceBase(TRepository repository) : base(repository) { }
