...
namespace VOL.Entity.Admin.Platform
{
    /// <summary>
    ...
    public abstract class YZHBaseEntity : BaseEntity
    {
        ...
        /// 注意：无 [Column] 映射；snake_case 表需用 new + [Column("creator")] 覆盖
        /// </summary>
        [MaxLength(50)]
        ...
        /// 注意：无 [Column] 映射；snake_case 表需用 new + [Column("modifier")] 覆盖
        /// </summary>
        [MaxLength(50)]
        ...
        /// 由框架在逻辑删除时自动填充
        /// 仅当 Enable = false 时有值
        /// 注意：无 [Column] 映射；snake_case 表需用 new + [Column("deleter")] 覆盖
        /// </summary>
        [MaxLength(50)]
        ...
        /// 默认值：active
        /// 注意：无 [Column] 映射；snake_case 表需用 new + [Column("status")] 覆盖
        /// </summary>
        [MaxLength(50)]
        ...
        /// 默认值：true
        /// 注意：无 [Column] 映射；snake_case 表需用 new + [Column("enable")] 覆盖
        /// </summary>
