 ...
 *业务请在@/extension/cert/AuditTask.jsx或AuditTask.vue文件编写
 -->
<template>
  <view-grid
    ref="grid"
...
import extend from "@/extension/cert/AuditTask.jsx";
...
const handleCustomAction = () => {
  ...
  proxy.$message.success(`操作: ${selectedRow.value.task_number}`);
};
