...
namespace YZH.Entity.Admin.Platform.Ent
{
    ...
    public class Enterprise : EntityBase
    {
        ...
        // DeleteID, Deleter, DeleteTime, Status, Enable, Remark 继承自 EntityBase
        // EntityBase 属性名是 PascalCase，但数据库列名是 snake_case
        // 需要在 EntityBase 中添加 [Column] 特性，或在子类中 override
    }
}
