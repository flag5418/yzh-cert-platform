...
function openEdit(_row: any) {
  // TODO: 打开编辑弹窗
}

function doDelete(_row: any) {
  // TODO: 删除报告
}
...
<template>
  <YzhPageLayout title="报告规则定义">
    ...
    <el-card shadow="never">
      <el-table :data="reportList" stripe border v-loading="loading">
        <el-table-column prop="reportCode" label="报告编码" width="180" />
