...
import type { TreeItemDto, PagedResult } from '@share/types/contracts'
...
export function getOrgRootNodes(): Promise<TreeItemDto[]> {
  return yzhApi.post('/api/Organization/tree/root', {})
}

/** 懒加载子节点 */
export function getOrgChildren(parentCode: string, level: number): Promise<TreeItemDto[]> {
  return yzhApi.post('/api/Organization/tree/children', { parentCode, level })
}

/** 新增机构 */
export function addOrg(data: Record<string, any>): Promise<any> {
  return yzhApi.post('/api/Organization/tree/add', data)
}

/** 修改机构 */
export function updateOrg(data: Record<string, any>): Promise<any> {
  return yzhApi.post('/api/Organization/tree/update', data)
}

/** 删除机构 */
export function deleteOrg(codes: string[]): Promise<any> {
  return yzhApi.post('/api/Organization/tree/delete', codes)
}
...
export function getUserPage(params: {
  ...
  return yzhApi.post('/api/Organization/filter', params)
}

/** 新增人员 */
export function addUser(data: Record<string, any>): Promise<any> {
  return yzhApi.post('/api/Organization/add', data)
}

/** 修改人员 */
export function updateUser(data: Record<string, any>): Promise<any> {
  return yzhApi.post('/api/Organization/update', data)
}

/** 删除人员 */
export function deleteUsers(codes: string[]): Promise<any> {
  return yzhApi.post('/api/Organization/delete', codes)
}
...
export function getOrgConfig(): Promise<any> {
  return yzhApi.get('/api/Organization/config')
}
