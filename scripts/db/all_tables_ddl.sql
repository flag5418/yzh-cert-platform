...
CREATE TABLE `sys_config` (
  ...
  `Creator` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '创建人姓名',
  `CreateDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `ModifyID` int DEFAULT NULL COMMENT '修改人ID',
  `Modifier` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '修改人姓名',
  `ModifyDate` datetime DEFAULT NULL COMMENT '修改时间',
  `DeleteID` int DEFAULT NULL COMMENT '删除人ID',
  `Deleter` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '删除人姓名',
  `DeleteTime` datetime DEFAULT NULL COMMENT '删除时间',
