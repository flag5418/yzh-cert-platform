...
INSERT INTO `Sys_Menu`
  (`Code`, `ParentCode`, `MenuName`, `Icon`, `OrderNo`, `Url`, `Tag`, `Description`, `Enable`, `IsValid`, `IsDeleted`, `CreateTime`, `CreateBy`)
VALUES
  ('MENU_AUD_00', '0',           '专家系统',   'Avatar',         300, '/',             'auditor', '专家端功能总入口（分类节点，不落地页）', 1, 1, 0, NOW(), 'seed_auditor'),
  ('MENU_AUD_01', 'MENU_AUD_00', '系统一览',   'Odometer',       100, '/overview',     'auditor', '驾驶舱：全局状态 / 能力就绪度 / 待办', 1, 1, 0, NOW(), 'seed_auditor'),
  ('MENU_AUD_02', 'MENU_AUD_00', '企业管理',   'OfficeBuilding', 200, '/enterprises',  'auditor', '企业档案列表 + 新建企业向导', 1, 1, 0, NOW(), 'seed_auditor'),
  ('MENU_AUD_03', 'MENU_AUD_00', '任务中心',   'List',           300, '/tasks',        'auditor', '跨企业任务视角：NC 检查 / 报告生成 / 我的关注', 1, 1, 0, NOW(), 'seed_auditor'),
  ('MENU_AUD_04', 'MENU_AUD_00', '资料库',     'FolderOpened',   400, '/resources',    'auditor', '跨企业资料检索 + 目录模板', 1, 1, 0, NOW(), 'seed_auditor'),
  ('MENU_AUD_05', 'MENU_AUD_00', '组织与成员', 'UserFilled',     500, '/organization', 'auditor', '成员管理 + 角色分组', 1, 1, 0, NOW(), 'seed_auditor'),
  ('MENU_AUD_06', 'MENU_AUD_00', '系统设置',   'Setting',        600, '/settings',     'auditor', '个人信息 / 账户与用量 / 消息设置 / 操作日志', 1, 1, 0, NOW(), 'seed_auditor')
...
SELECT `Code`, `ParentCode`, `MenuName`, `Url`, `Icon`, `OrderNo`, `Enable`, `Tag`
FROM `Sys_Menu`
